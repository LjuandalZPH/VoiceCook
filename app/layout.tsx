...
export const metadata: Metadata = {
  ...
  description: 'A futuristic culinary hands-free smart cooking assistant designed for a clean sensory kitchen experience.',
};

export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="es" className={`${inter.variable} ${playfairDisplay.variable} dark`}>
      <body suppressHydrationWarning className="bg-[#0a0c10] text-slate-100 font-sans min-h-screen selection:bg-teal-500/30 selection:text-teal-200 antialiased overflow-x-hidden relative">
